                ...
                <div class="overflow-x-auto">
                    <section class="">
                        <div class="py-2 px-4 mx-auto  max-w-4xl lg:pt-4 border-2 bg-gray-700 rounded-lg mt-6">
                            <h2 class="mb-4 text-center text-xl font-bold text-gray-900 dark:text-white">Add a new user</h2>
                            <form action="usercreateprocess.php" method="Post" enctype="multipart/form-data">
                                <?php if (isset($_GET["status"]) && $_GET["status"] == "user_is_created") { ?>
                                    <p class="text-green-400 font-bold">New user is created successfully!.</p>
                                <?php } ?>
                                <div class="grid gap-4 sm:grid-cols-2 sm:gap-3">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter a password">
                                    </div>
                                    
                                        <div class="w-full">
                                            <?= isset($_GET["validation"]) ? '<p class="text-red-500"> Empty Field. </p>' : null ?>
                                            <label for="phone_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Number</label>
                                            <input type="tel" pattern="\+[0-9]{11}" name="phone_number" id="phone_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 md:w-1/2 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="+95771017996">
                                        </div>
