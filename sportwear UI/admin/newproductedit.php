    ...
    <div class="flex items-start">
      ...
      <section class="main-content w-full">
        <div class="overflow-x-auto pt-1">
          <section class="">
            <div class="py-2 px-4 mx-auto  max-w-4xl lg:pt-4 border-2 bg-gray-700 rounded-lg">
              <h2 class="mb-4 text-center text-xl font-bold text-gray-900 dark:text-white">Update product</h2>
              <form action="editprocess.php" method="Post" enctype="multipart/form-data">
                <?php if (isset($_GET["status"]) && $_GET["status"] == "product_is_updated") { ?>
                  <p class="text-green-400 font-bold">product is updated successfully!.</p>
                <?php } ?>
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-2">
                  ...
                  <div>
                    <?php $image = isset($_GET['image_url']) ? $_GET['image_url'] : $products['img_url'] ?>
                  ...
                  <div class="sm:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3" class="block p-2.5 resize-none w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Your description here"><?= $product['Description'] ?></textarea>
                  </div>
                </div>
                <div class="flex justify-center">
                  <button class="cursor-pointer transition-all bg-blue-500 text-white px-64 py-2 rounded-lg mt-4
                    border-blue-600
