...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $Allsaledetail = getSale_detailById($pdo, $sale_id);
          ...
          <table class="min-w-full md:w-1/3 border-2 border-black">
            <thead class="bg-gray-800 whitespace-nowrap border-2 border-black">
              <tr>
                ...
                <th class="p-4 text-md font-medium text-white text-center">First Name</th>
            ...
            <?php foreach ($Allsaledetail as $saledetail): ?>
              <tbody class="whitespace-nowrap bg-gray-200">
                <tr class="even:bg-blue-50">
                  ...
                  <td class="p-4 text-sm text-black text-center"><?= $saledetail["First_name"] ?></td>
                  <td class="p-4 text-sm text-black text-center"><?= $saledetail["Last_name"] ?></td>
