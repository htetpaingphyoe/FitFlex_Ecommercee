        ...
        <div class="overflow-x-auto">
          <section class="">
            <div class="py-2 px-4 mx-auto  max-w-4xl lg:pt-4 border-2 bg-gray-700 rounded-lg mt-6">
              <h2 class="mb-4 text-center text-xl font-bold text-gray-900 dark:text-white">Update Existing User</h2>
              <form action="usereditprocess.php" method="Post" enctype="multipart/form-data">
                <?php if (isset($_GET["status"]) && $_GET["status"] == "user_is_updated") { ?>
                  <p class="text-green-400 font-bold">user is updated successfully!.</p>
                <?php } ?>
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-3">
                  <div class="w-full">
                    ...
                    <input type="text" name="firstname" id="firstname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter first name" value="<?= $user['First_name'] ?>">
                  </div>
                  <div class="w-full">
                    <?= isset($_GET["validation"]) ? '<p class="text-red-500"> Empty Field. </p>' : null ?>
                    <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                    <input type="text" name="lastname" id="lastname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter last name" value="<?= $user['Last_name'] ?>">
                  </div>
                  <div class="w-full">
                    <?= isset($_GET["validation"]) ? '<p class="text-red-500"> Empty Field. </p>' : null ?>
                    <label for="gmail" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gmail</label>
                    <input type="email" name="gmail" id="gmail" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter gmail" value="<?= $user['Gmail'] ?>">
                  </div>
                  <div class="w-full">
                    <?= isset($_GET["validation"]) ? '<p class="text-red-500"> Empty Field. </p>' : null ?>
                  ...
                  <div class="w-full">
                    ...
                    <input type="tel" pattern="\+[0-9]{11}" name="phone_number" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 md:w-1/2 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="+95771017996" value="<?= $user['Ph_number'] ?>">
                  </div>
                  <div class="w-full lg:-ml-52 col-span-1">
                    <?= isset($_GET["validation"]) ? '<p class="text-red-500"> Empty Field. </p>' : null ?>
                    <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                    <input type="address" name="address" id="address" class="bg-gray-50 border border-gray-300 text-gray-900 lg:w-[149%] text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter address" value="<?= $user['Address'] ?>">
                  </div>
                </div>
