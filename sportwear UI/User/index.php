...
<body>
                        ...
                        <div class="w-full flex">
                            <div class="w-1/2 h-auto pt-[50px] pl-36 mr-14" id="textdiv">
                                ...
                                <div class="flex h-auto pl-14 -mt-10" id="undertextdiv">
                                    ...
                                    <button class="px-10 py-4 text-white text-3xl bg-[#795757] rounded-full hover:px-12 hover:bg-[#664343] ease-in duration-300 ml-4" style="font-family: 'Bebas Neue', sans-serif;" id="button1">Buy Now!</button>
                                </div>    
                            </div>
                        ...
                        <div class="w-full flex">
                            <div class="w-full h-auto pt-[50px] ml-40 mt-10 mr-[1000px]" id="textdiv">
                                ...
                                <div class="flex h-auto pl-14 -mt-6">
                                    <button class="px-10 py-4 text-white text-3xl bg-[#795757] rounded-full hover:px-12 hover:bg-[#664343] ease-in duration-300 ml-28" style="font-family: 'Bebas Neue', sans-serif;">Buy Now!</button>
                                </div>    
                            </div>
                        </div>
                    </div>
            ...
            <div class="item">
                ...
                <div class="w-full h-auto ml-[-12px] mr-[400px]" id="thirdslider">
                    ...
                    <div class="w-full flex justify-center pb-10 mt-4">
                        <button class="text-3xl px-10 py-4 font-thin text-white rounded-full bg-yellow-600 hover:bg-yellow-400 hover:text-black hover:px-12 ease-in duration-300" style="font-family: 'Bebas Neue', sans-serif;">Go To Store</button>
                    </div>
                </div>
            </div>
            <div class="item">
                ...
                <div class="flex w-full h-auto bg-cover bg-top bg-no-repeat brightness-[95%] justify-center items-center mr-[400px]" style="background-image: url(../img/background2.jpg);">
                    <div class="w-1/2 h-auto mt-28 mb-32 pl-20">
                        ...
                        <button class="px-6 py-2 bg-white text-3xl font-thin tracking-wide hover:tracking-wider rounded-full ml-6 hover:px-10 duration-300 ease-in hover:bg-red-600 hover:text-white" style="font-family: 'Bebas Neue', sans-serif;">Buy Now!</button>
                    </div>
    ...
    <div class="flex flex-wrap" id="secondcontainer">
        ...
        <div class="max-w-sm h-auto p-6 bg-white rounded-lg shadow dark:bg-[#664343] dark:border-gray-700 mt-20 ml-24" id="card3">
            ...
            <a href="#" class="inline-flex items-center py-4 px-2 ml-[112px] text-xl font-medium text-center text-white bg-[#3B3030] rounded-lg hover:bg-white-200 hover:text-black hover:ml-[100px] hover:px-6 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#3B3030] dark:hover:bg-white dark:focus:ring-blue-800 duration-700 hover:tracking-wider" style="font-family: 'Bebas Neue', sans-serif;">
                View More
                <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
