<div class="w-full xl:px-20 lg:px-12 sm:px-6 px-4 py-12 bg-black mt-10">
            <div class="flex flex-col items-center justify-center">
                <div>
                <a href="index.php" class="hover:text-white ml-4 text-5xl text-red-700 font-bold" style="font-family: 'Bungee Shade', sans-serif;">FitFlex</a>
                </div>
                <div class="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white dark:text-white dark:hover:text-red-700">About</a>
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white dark:text-white dark:hover:text-red-700">Contact us</a>
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white dark:text-white dark:hover:text-red-700">Terms of Service</a>
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white dark:text-white dark:hover:text-red-700">Privacy Policy</a>
                </div>
                <div class="flex items-center gap-x-8 mt-6">
                    <button aria-label="facebook" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
                        <svg class="fill-current text-white dark:text-white hover:text-red-700" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button aria-label="instagram" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
                        <svg class="fill-current text-white dark:text-white hover:text-red-700" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button aria-label="pinterest" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
                        <svg class="fill-current text-white dark:text-white hover:text-red-700" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="flex items-center mt-6">
                    <p class="text-base leading-4 text-white dark:text-white font-sans">2025 <span class="font-semibold">FITFLEX</span></p>
                    <div class="border-l border-gray-800 pl-2 ml-2">
                        <p class="text-base leading-4 text-gray-500 dark:text-gray-500">Inc. All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
