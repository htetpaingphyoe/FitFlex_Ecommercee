<footer class="bg-gray-900 pt-12 mt-10 pb-6 px-10 font-[sans-serif] tracking-wide">
      <div class="max-w-screen-xl mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="lg:flex lg:items-center">
                <a href="index.html" class="hover:text-red-600 ml-4 text-5xl text-gray-400 font-bold" style="font-family: 'Bungee Shade', sans-serif;">FitFlex</a>
          </div>
        ...
        <p class='text-gray-300 text-sm mt-10'>© FitFlex. All rights reserved.
        </p>
      </div>
    </footer>