...
?>
<div class="font-sans p-8 tracking-wide max-w-7xl max-lg:max-w-2xl max-lg:mx-auto">
      <div>
        <h2 class="text-xl font-bold text-gray-800">Dark blue sneakers with white laces</h2>
        ...
        <div class="lg:col-span-3">
          <div class="grid sm:grid-cols-3 gap-2 text-center">
            <div class="sm:col-span-2 bg-gray-100 p-4 flex items-center rounded">
              <img src="https://readymadeui.com/images/product14.webp" alt="Product" class="w-full aspect-[5/4] object-contain object-top" />
            </div>
        ...
        <div class="w-full lg:col-span-2">
          ...
          <div class="mt-6">
            ...
            <div class="flex flex-wrap gap-4 mt-4">
              <button type="button" class="w-12 h-12 border hover:border-purple-600 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">SM</button>
              <button type="button" class="w-12 h-12 border hover:border-purple-600 border-purple-600 font-semibold text-purple-800 text-sm rounded-full flex items-center justify-center shrink-0">MD</button>
              <button type="button" class="w-12 h-12 border hover:border-purple-600 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">LG</button>
              <button type="button" class="w-12 h-12 border hover:border-purple-600 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">XL</button>
            </div>
          </div>

          <div class="flex gap-4 mt-6">
            <button type="button" class="w-full px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold rounded">Buy now</button>
            <button type="button" class="w-full px-4 py-2.5 border border-purple-600 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Add to cart</button>
          </div>
