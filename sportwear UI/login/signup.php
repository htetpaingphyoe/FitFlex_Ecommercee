...
<head>
  ...
  <style>
    body {
      background-image: url("../User/img/newwhitebackground.jpg");
...
<body>
  <div class="max-w-4xl mx-auto font-[sans-serif] p-6 mt-10" id="signup">
    <div class="text-center mb-10">
      <a href="../User/index.php">
        <h1 class="text-6xl font-bold" style="font-family: 'Bungee Shade', sans-serif;" id="title">FitFlex</h1>
      </a>
      <h4 class="text-gray-800 text-base font-semibold mt-4 font-Roboto">Sign up into your account</h4>
    </div>
    <form action="signupprocess.php" method="POST">
      ...
      <!-- <div class="flex flex-col mt-4 space-y-0.5">
        ...
        <div class=" mt-4">
        <h1 class=" text-sm">Already a user? <a href="login.php" class="text-black hover:text-blue-500 font-bold">Login here!</a></h1>
      </div>
